...
class DMakerControllerTest {
    ...
    void getAllDevelopers() throws Exception {
        DeveloperDto juniorDeveloperDto = DeveloperDto.builder()
                ...
                .developerSkillLevel(DeveloperSkillLevel.BACK_END)
                .memberId("memberId1").build();

        DeveloperDto seniorDeveloperDto = DeveloperDto.builder()
                .developerLevel(DeveloperLevel.SENIOR)
                .developerSkillLevel(DeveloperSkillLevel.FRONT_END)
        ...
        mockMvc.perform(get("/developers").contentType(contentType))
                ...
                .andDo(print())
                .andExpect(
                        jsonPath("$.[0].developerSkillLevel",
                                is(DeveloperSkillLevel.BACK_END.name()))
                )
                .andExpect(
                ...
                .andExpect(
                        jsonPath("$.[1].developerSkillLevel",
                                is(DeveloperSkillLevel.FRONT_END.name()))
                )
                .andExpect(
